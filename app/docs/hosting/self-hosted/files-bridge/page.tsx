    ...
    >
      <PublicDocsCard title="What this unlocks">
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>
            Edit and save text files (`.md`, `.txt`, `.json`, `.yaml`, `.yml`,
            `.toml`, `.config`).
          </li>
          <li>
...
docker run --rm -p 8787:8787 \\
  ...
  sutraha-fs-bridge`}
        ...
        <PublicDocsCallout title="Per-user root path">
          ...
          `WORKSPACE_ROOT_PATH` to whatever directory contains their OpenClaw
          workspace.
        </PublicDocsCallout>
      </PublicDocsCard>
...
docker push ghcr.io/sutraha/sutraha-fs-bridge:0.1.0`}
      ...
      <PublicDocsCard title="3) Configure Synclaw">
        <ol className="list-decimal space-y-2 pl-5">
          ...
          <li>
            Enable <span className="font-medium">Workspace Files Bridge</span>.
          </li>
          <li>Set bridge URL and workspace root path.</li>
          <li>Set bridge token and click Save.</li>
          <li>
            Use <span className="font-medium">Workspace Files (Remote)</span>{" "}
            and click Test bridge.
          </li>
        </ol>
      </PublicDocsCard>
      ...
      <PublicDocsCard title="4) Security baseline">
        <ul className="list-disc space-y-2 pl-5">
          <li>
            ...
            per bridge deployment.
          </li>
          <li>
            Expose bridge behind HTTPS and private networking when possible.
          </li>
          <li>
            Keep root path minimal (only agent workspace directory, not full
            server root).
          </li>
